...
<c:set var="name" value="Amy" /> <% pageContext.setAttribute("name","Amy"); %>
<c:out value="${name}" /><br>	<%-- out.print(name); --%>
...
<c:set var="title" value="${bookOne.title}" /> <% pageContext.setAttribute("title",book.getTitle()); %>											%>
